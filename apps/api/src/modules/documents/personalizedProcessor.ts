...
export class PersonalizedProcessor {
  ...
  private applyUserPreferences(
    ...
    // **Evitar confianza 0**: poner un piso para que no se convierta en "fallo"
    const MIN_CONFIDENCE_FLOOR = 0.3;
    const adjustedConfidence = Math.max(baseResult.confidence * matchRatio, MIN_CONFIDENCE_FLOOR);
